...
#define THOR_FORWARD_CLASS(className)	\
		class className;\
		typedef ThRefPtr<className> className##Ptr;\
		typedef ThRefPtr<const className> className##CPtr;\
...
#define THOR_FORWARD_STRUCT(structName)	\
		struct structName;\
		typedef ThRefPtr<structName> structName##Ptr;\
		typedef ThRefPtr<const structName> structName##CPtr;\
