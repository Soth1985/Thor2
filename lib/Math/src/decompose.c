...
QuatXX Qt_(float x, float y, float z, float w)
{
    QuatXX qq;
...
QuatXX Qt_Mul(QuatXX qL, QuatXX qR)
{
    QuatXX qq;
...
QuatXX Qt_Scale(QuatXX q, float w)
{
    QuatXX qq;
...
#define cycle(a,p)  if (p) {a[3]=a[0]; a[0]=a[1]; a[1]=a[2]; a[2]=a[3];}\
	...
	unsigned neg[3], win;
	double mag[3], t;
	static QuatXX qxtoz = {0,SQRTHALF,0,SQRTHALF};
	static QuatXX qytoz = {SQRTHALF,0,0,SQRTHALF};
	static QuatXX qppmm = { 0.5, 0.5,-0.5,-0.5};
	static QuatXX qpppp = { 0.5, 0.5, 0.5, 0.5};
	static QuatXX qmpmm = {-0.5, 0.5,-0.5,-0.5};
	static QuatXX qpppm = { 0.5, 0.5, 0.5,-0.5};
	static QuatXX q0001 = { 0.0, 0.0, 0.0, 1.0};
	static QuatXX q1000 = { 1.0, 0.0, 0.0, 0.0};
	switch (turn) {
