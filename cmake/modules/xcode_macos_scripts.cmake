...
function (thor_macos_target_setup_console_app target)
if (MACOS)
	thor_macos_target_setup_compiler_shared(${target})
	thor_target_install(${target})
	...
	thor_set_xcode_property(${target} INSTALL_PATH "/Applications")
endif()
endfunction()
...
if (MACOS)
	...
	thor_set_xcode_property(${target} MACH_O_TYPE "mh_execute")
