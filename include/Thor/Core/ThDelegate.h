...
namespace Private
{
	...
	public:
		...
		typedef std::function< FuncT >                                  function_t;
	...
	protected:
		...
		bool Disconnect(Connection* con)
		{
            if(!con)
				return false;
			//find connection
			typename connection_list_t::iterator pos = m_Connections.end();
			for( typename connection_list_t::iterator i = m_Connections.begin(); i != m_Connections.end(); ++i )
			{
...
public:
	...
	{
        for( ThSize i = 0; i < base_t::m_Connections.size(); ++i )
		{
            base_t::m_Connections[i].m_Func(a0);
		}
	}
};
...
public:
	...
	void operator()(Arg0 a0, Arg1 a1)
	{
		for( ThSize i = 0; i < base_t::m_Connections.size(); ++i )
		{
			base_t::m_Connections[i].m_Func(a0, a1);
		}
	}
};
...
public:
	...
	void operator()(Arg0 a0, Arg1 a1, Arg2 a2)
	{
		for( ThSize i = 0; i < base_t::m_Connections.size(); ++i )
		{
			base_t::m_Connections[i].m_Func(a0, a1, a2);
		}
	}
};
...
public:
	...
	void operator()(Arg0 a0, Arg1 a1, Arg2 a2, Arg3 a3)
	{
		for( ThSize i = 0; i < base_t::m_Connections.size(); ++i )
		{
			base_t::m_Connections[i].m_Func(a0, a1, a2, a3);
		}
	}
};
...
public:
	...
	void operator()(Arg0 a0, Arg1 a1, Arg2 a2, Arg3 a3, Arg4 a4)
	{
		for( ThSize i = 0; i < base_t::m_Connections.size(); ++i )
		{
			base_t::m_Connections[i].m_Func(a0, a1, a2, a3, a4);
		}
	}
};
...
public:
	...
	void operator()(Arg0 a0, Arg1 a1, Arg2 a2, Arg3 a3, Arg4 a4, Arg5 a5)
	{
		for( ThSize i = 0; i < base_t::m_Connections.size(); ++i )
		{
			base_t::m_Connections[i].m_Func(a0, a1, a2, a3, a4, a5);
		}
	}
};
...
public:
	...
	void operator()(Arg0 a0, Arg1 a1, Arg2 a2, Arg3 a3, Arg4 a4, Arg5 a5, Arg6 a6)
	{
		for( ThSize i = 0; i < base_t::m_Connections.size(); ++i )
		{
			base_t::m_Connections[i].m_Func(a0, a1, a2, a3, a4, a5, a6);
		}
	}
};
...
public:
	...
	void operator()(Arg0 a0, Arg1 a1, Arg2 a2, Arg3 a3, Arg4 a4, Arg5 a5, Arg6 a6, Arg7 a7)
	{
		for( ThSize i = 0; i < base_t::m_Connections.size(); ++i )
		{
			base_t::m_Connections[i].m_Func(a0, a1, a2, a3, a4, a5, a6, a7);
		}
	}
};
...
public:
	...
	void operator()(Arg0 a0, Arg1 a1, Arg2 a2, Arg3 a3, Arg4 a4, Arg5 a5, Arg6 a6, Arg7 a7, Arg8 a8)
	{
		for( ThSize i = 0; i < base_t::m_Connections.size(); ++i )
		{
			base_t::m_Connections[i].m_Func(a0, a1, a2, a3, a4, a5, a6, a7, a8);
		}
	}
};
...
public:
	...
	void operator()(Arg0 a0, Arg1 a1, Arg2 a2, Arg3 a3, Arg4 a4, Arg5 a5, Arg6 a6, Arg7 a7, Arg8 a8, Arg9 a9)
	{
		for( ThSize i = 0; i < base_t::m_Connections.size(); ++i )
		{
			base_t::m_Connections[i].m_Func(a0, a1, a2, a3, a4, a5, a6, a7, a8, a9);
		}
	}
};
