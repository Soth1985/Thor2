...
v2f vertex vertexMain7( device const VertexData* vertexData [[buffer(0)]],
...
half4 fragment fragmentMain7( v2f in [[stage_in]], texture2d< half, access::sample > tex [[texture(0)]] )
{
