...
simd::float3 MetalMath::add( const simd::float3& a, const simd::float3& b )
{
    return { a.x + b.x, a.y + b.y, a.z + b.z };
}

simd_float4x4 MetalMath::makeIdentity()
{
    using simd::float4;
...
simd::float4x4 MetalMath::makePerspective( float fovRadians, float aspect, float znear, float zfar )
{
    using simd::float4;
...
simd::float4x4 MetalMath::makeXRotate( float angleRadians )
{
    using simd::float4;
...
simd::float4x4 MetalMath::makeYRotate( float angleRadians )
{
    using simd::float4;
    const float a = angleRadians;
...
simd::float4x4 MetalMath::makeZRotate( float angleRadians )
{
    using simd::float4;
    const float a = angleRadians;
...
simd::float4x4 MetalMath::makeTranslate( const simd::float3& v )
{
    using simd::float4;
...
simd::float4x4 MetalMath::makeScale( const simd::float3& v )
{
    using simd::float4;
...
simd::float3x3 MetalMath::discardTranslation( const simd::float4x4& m )
{
